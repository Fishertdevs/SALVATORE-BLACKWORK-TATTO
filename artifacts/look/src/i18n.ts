...
export const galleryCopy = {
  es: {
    ...
    mobileHeroStyles: "ORNAMENTAL · TRIBAL · BLACKWORK",
    ...
    featuredLabel: "ALTERNATIVE DESIGN / BLACKWORK CULTURE",
    featuredParagraphs: [
    ...
    cultureMarquee: ["BLACKWORK", "FINE LINE", "DOTWORK", "ORNAMENTAL", "GEOMETRIC", "INK RITUAL"],
    archiveWorks: [
